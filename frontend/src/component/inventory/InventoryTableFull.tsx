...
import { CATEGORIES, LOW_STOCK_THRESHOLD } from './inventoryData'
...
export default function InventoryTableFull({ products, onEdit, onDelete }: Props) {
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
          <thead>
            <tr style={{ background: '#F5F6F8' }}>
              {['Product Name', 'Category', 'Price', 'GST %', 'Stock Qty', 'Status', 'Actions'].map(h => (
