...
export default function ViewerProfilePage() {
  ...
  // Personal info
  const [name,  setName]  = useState('Viewer User')
  const [email, setEmail] = useState('viewer@inventra.in')
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 24, alignItems: 'start' }} className="profile-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ ...card, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 0 }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 5, background: 'rgba(5,150,105,0.08)', color: '#059669', padding: '4px 12px', borderRadius: 20, fontSize: 12, fontWeight: 700, marginBottom: 8 }}>
              <ShieldCheck size={12} /> Viewer
            </div>
